...
export const metadata: Metadata = {
  ...
  description:
    "Eden connects builders who publish AI services with consumers who discover and run them. Powered by Leafs — transparent pricing, no hidden charges, contribution economy.",
};
