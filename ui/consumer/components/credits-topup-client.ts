...
export function buildPaymentTopUpReceipt(
  ...
  return {
    amountCredits,
    amountLabel: formatLeavesAmountLabel(payload.amountLabel ?? `+${amountCredits} Leaf's`),
...
export function buildTopUpProcessingMessage(
  ...
  return {
    ...
    title: "Payment processing",
      detail:
        message ??
      `${selectedPackage.title} has been submitted. Eden is waiting for Stripe webhook settlement before Leaf's are added.`,
  };
}
