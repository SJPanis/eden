      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div className="max-w-2xl">
          ...
          <p className="mt-2 text-sm leading-6 text-eden-muted">
            {summary ||
              "Run this service through Eden's current wallet-overlay path. The visible Eden Leaves price is what gets deducted, ServiceUsage is recorded, and no hidden payment rail is charged during the run."}
          </p>
        </div>
