  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(ellipse_160%_90%_at_top,rgba(20,152,154,0.10),rgba(255,255,255,0.98)_50%,rgba(210,223,235,0.3))] px-4 py-8 md:px-8">
      <div className="mx-auto flex w-full max-w-md flex-col gap-6">
        ...
        <Link
          href="/"
          className="flex items-center gap-2 text-sm text-eden-muted transition-colors hover:text-eden-ink w-fit"
        >
        ...
        <div>
          ...
          <h1 className="mt-4 text-2xl font-semibold tracking-tight text-eden-ink">
        ...
        {/* Form */}
        <form
          className="flex flex-col gap-4 rounded-[28px] border border-eden-edge bg-white/94 p-6 shadow-[0_8px_32px_-12px_rgba(16,37,58,0.10)]"
        ...
        >
          <label className="flex flex-col gap-2 text-sm text-eden-muted">
            ...
            <input
              ...
              className="rounded-2xl border border-eden-edge bg-white px-4 py-3 text-sm text-eden-ink outline-none transition focus:border-eden-ring focus:ring-2 focus:ring-eden-ring/30"
        ...
        <p className="text-center text-xs text-eden-muted">
