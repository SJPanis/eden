...
export const transactions: EdenMockTransaction[] = [
  {
    ...
    direction: "inflow",
    kind: "wallet",
    detail: "Northstar Habit Lab received a mock Leaf’s top-up for testing and publish prep.",
    timestamp: "09:42",
  },
  {
    id: "transaction-02",
  ...
  },
  {
    ...
    direction: "reserve",
    kind: "reserve",
    detail: "Leaf’s were moved into a mock safety hold before publish validation.",
    timestamp: "08:57",
  },
  {
    id: "transaction-04",
