...
const baseCreditsTopUpPackages = [
  {
    id: "credits-275",
    packLabel: "Starter \u2014 10% Bonus",
    creditsAmount: 275,
    amountCents: 1000,
    title: "250 + 25 bonus Leaf’s",
    detail: "Best for lightweight discovery and a few priced service runs.",
  },
  {
    id: "credits-1150",
    packLabel: "Balanced \u2014 15% Bonus",
    creditsAmount: 1150,
    amountCents: 3500,
    title: "1000 + 150 bonus Leaf’s",
    detail: "Best for repeat consumer usage and steady marketplace exploration.",
  },
  {
    id: "credits-3250",
    packLabel: "High Balance \u2014 30% Bonus",
    creditsAmount: 3250,
    amountCents: 8000,
    title: "2500 + 750 bonus Leaf’s",
